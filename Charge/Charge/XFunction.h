...
#define JSON_ERROR_CODE                         @"errCode"
#define JSON_FLAG                               @"flag"
#define JSON_DEFAULT_FLAG                       @"default"

#define XPAGE_RESULT                            @"result"
#define XPAGE_NO                                @"pageNo"
#define XPAGE_SIZE                              @"pageSize"
#define XPAGE_COUNT                             @"totalCount"
#define XPAGE_PAGES                             @"totalPages"

#define REQUEST_MODE                            @"http://"
#define WEB_URL                                 @"feiren.17learning.com"

#define UmengAppkey                             @"55a8723c67e58efb320004b9"
#define ChANNEL_ID                              @"feiren"

#define XYReceiveNewPush                        @"XYReceiveNewPush"
#define XYGetExperienceByLogin                  @"getExperienceByLogin"
