...
-(void)setProgress:(CGFloat)progress animated:(BOOL)animated{
    ...
    [CATransaction setAnimationDuration:AnimationIntertime];
...
-(void)setProgress:(CGFloat)progress{
    ...
    [self.countLabel updateLabel:[str integerValue] withAnimationTime:AnimationIntertime];
