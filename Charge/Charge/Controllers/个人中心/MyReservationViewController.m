...
@property (nonatomic, strong) NSString *distanceStr;//预约充电站距离
...
-(void)creatUI
{
    ...
    __weak MyReservationViewController *weakSelf = self;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    }else
    {
        ...
        if (indexPath.section == 1 && indexPath.row == 1) {
            [cell.detailTextLabel setText:[NSString stringWithFormat:@"%@元",_yuYueCost]];
            cell.detailTextLabel.font = [UIFont systemFontOfSize:13];
...
//            
//            //加5小时
//            NSTimeInterval time = 60*60*5;
//            NSDate * newData = [currentDate dateByAddingTimeInterval:time];
//            NSString *newdateString = [dateFormatter stringFromDate:newData];
//            MYLog(@"dateString:%@",dateString);
//            MYLog(@"newdateString:%@",newdateString);
