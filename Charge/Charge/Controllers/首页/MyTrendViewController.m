...
//    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:image style:UIBarButtonItemStyleDone target:self action:@selector(back)];
    ...
    //初始化自定义nav
    NavView *nav = [[NavView alloc] initWithFrame:CGRectZero title:@"我的动态"];
    nav.backBlock = ^{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    MyTrendTableViewCell * SystemTableCell = [tableView dequeueReusableCellWithIdentifier:cellIdetifier];
    if (SystemTableCell == nil) {
        SystemTableCell = [[[NSBundle mainBundle]loadNibNamed:@"MyTrendTableViewCell" owner:nil options:nil]lastObject];
    }
    [SystemTableCell setSelectionStyle:UITableViewCellSelectionStyleNone];
    
    MyTrendModel *dataArray = _MyTrendDataArray[indexPath.section];

    SystemTableCell.stationNames = dataArray.stationName;
    SystemTableCell.endTimes = dataArray.createDate;
    SystemTableCell.costs = dataArray.totalCost;
